...
class session_conversation
{
    ...
    public function create($duree_session, $date_heure_fin, $id_agents, $id_users)
    {
        $sql = "INSERT INTO session_conversation (duree_session, date_heure_fin, id_agents, id_users) 
...
public function update($id_session, $date_heure_debut, $duree_session, $date_heure_fin, $id_agents, $id_users)
    {
