...
require_once __DIR__ . '/../controllers/MatieresController.php';

use Controllers\MatiereController;
use Controllers\MatieresController;
...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    $message = "ID matiére manquant.";
} else {
    $id_matieres = $_GET['id'];
    $matiere = $controller->getSingleEtudiant($id_matieres);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirmer_suppression'])) {
    ...
    $result = $controller->deleteMatiere($id_matieres);
