...
foreach ($etudiants as $etudiant) {
    ...
    echo "<td>" . htmlspecialchars($etudiant['libelle_niveau'] ?? $etudiant['id_niveau']) . "</td>"; 
    echo "<td>" . htmlspecialchars($etudiant['nom_role'] ?? $etudiant['id_role']) . "</td>";
    echo "<td>" . ($etudiant['consentement_rgpd'] ? 'Oui' : 'Non') . "</td>";
    echo "<td><a href='etudiant_update.php?id=" . htmlspecialchars($etudiant['id_etudiant']) . "'>Modifier</a> | <a href='etudiant_delete.php?id=" . htmlspecialchars($etudiant['id_etudiant']) . "'>Supprimer</a></td>";
    echo "</tr>";
}
echo "</table>";
?>